...
CREATE INDEX idx_mcp_execution_tool_uuid ON app_core.mcp_execution(tool_uuid);
CREATE INDEX idx_mcp_execution_status_text ON app_core.mcp_execution(status_text);
